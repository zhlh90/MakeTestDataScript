...
def make_sql(agency_code_num,ins_no, n):
    ...
    while (n > 0):
        ...
        sqlG = "insert into SMR_UNIT_PAYMENT_DETAIL values (%(ID)s, %(CREATE_BY)s, %(CREATE_DATE)s, %(LAST_MODIFIED_BY)s, %(LAST_MODIFIED_DATE)s, %(LAST_MODIFIED_VERSION)s, %(AAA027)s, %(AAA041)s, %(AAA042)s, %(AAA115)s, %(AAA321)s, %(AAA322)s, %(AAB001)s, %(AGENCY_CODE)s, %(AAB084)s, %(AAB119)s, %(AAB120)s, %(AAB121)s, %(AAB165)s, %(AAD009)s, %(AAE003)s, %(AAE056)s, %(AAE080)s, %(AAE082)s, %(INSURANCE_CODE)s, %(AAE239)s, %(AAE418)s, %(AAE530)s, %(AAE531)s, %(AAF020)s, %(AAZ288)s, %(AAZ400)s, %(PLAN_ID)s, %(REC_STATUS)s, %(REC_NO)s, %(REC_TIME)s, %(EXCHANGE_PLAN_ID)s, %(EXCHANGE_PLAN_STATUS)s, %(VOU_GUID)s, %(VOU_NO)s, %(VOU_DATE)s, %(VOU_STATUS)s, %(FIELD01)s, %(FIELD02)s, %(FIELD03)s, %(FIELD04)s, %(FIELD05)s, %(FIELD06)s, %(FIELD07)s, %(FIELD08)s, %(FIELD09)s, %(FIELD10)s, %(FIELD11)s, %(FIELD12)s, %(FIELD13)s, %(FIELD14)s, %(FIELD15)s, %(FIELD16)s, %(FIELD17)s, %(FIELD18)s, %(FIELD19)s, %(FIELD20)s, %(AMT01)s, %(AMT02)s, %(AMT03)s, %(AMT04)s, %(AMT05)s, %(AMT06)s, %(AMT07)s, %(AMT08)s, %(AMT09)s, %(AMT10)s, %(UUID)s, %(AGENCY_NAME)s, %(INSURANCE_NAME)s)"
        value = {
        "ID": ID,
        "CREATE_BY": CREATE_BY,
