...
# 生成小写字母加数字30位
        ...
        CREATE_DATE = datetime.datetime.fromisoformat('2021-01-02 19:00:00').strftime("%Y-%m-%d %H:%M:%S")
...
if __name__ == '__main__':
    ...
    # 现金结算
    # make_sql('01', '上海市黄浦区', '01', 1)
    # 银行卡支付
    # make_sql('01', '上海市黄浦区', '02', 1)
    # 异地银行卡支付
    # make_sql('01', '上海市黄浦区', '12', 1)
    # 税务隔日退费
    make_sql('01', '上海市黄浦区', '15', 1)
