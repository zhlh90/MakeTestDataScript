...
# 统筹区
cl_insurance_code = ['110','150']
cl_insurance_name = ['城镇企业职工基本养老保险','城乡居民基本养老保险']
# 经办机构
cl_agency_code = ['00','01','34010001']
cl_agency_name = ['上海市保险事业管理局','黄浦区保险事业管理局','合肥市职工养老保险中心']
# 行政区划
cl_org_code = ['310000','310100','34010001']
cl_org_name = ['上海市','黄浦区','安徽省合肥市']
# 业务类型 401-非现金，402-现金,现金、非现金子表pay_type需要更改
...
def make_sql(org_code,insur_num,n):
    ...
    while(n>0):
        ...
        AREA_CODE = cl_org_code[org_code]
        AREA_NAME = cl_org_name[org_code]
        CENTER_CODE = cl_agency_code[org_code]
        CENTER_NAME = cl_agency_name[org_code]
        PAY_PERIOD = otherStyleTime6
        BUSINESS_TYPE = 'K1002401'
        PAY_TYPE = '2'
        STATUS = '0'
