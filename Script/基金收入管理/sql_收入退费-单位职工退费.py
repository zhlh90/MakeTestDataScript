...
def make_sql(agency_code, insurance_code, n):
    ...
    if not isExists:
        # 如果不存在则创建目录
        os.mkdir(path)
    file_name = path + 'dwperson'+str(otherStyleTime3)+'.sql'
    ...
    # 主子表sql
    str_head_zhu = "insert into SMR_REFUND values ("
    str_head_item = "insert into SMR_REFUND_UNIT values ("
