...
# 生成小写字母加数字30位
        ...
        line = str_head_zhu + '"' + ID + '", "' + CREATE_BY + '", ' + 'TO_TIMESTAMP(\'' + CREATE_DATE + '\',\'SYYYY-MM-DD HH24:MI:SS:FF6\'), ' + '"' + LAST_MODIFIED_BY + '", TO_TIMESTAMP(\'' + LAST_MODIFIED_DATE + '\',\'SYYYY-MM-DD HH24:MI:SS:FF6\'), "' + \
               ...
               COMMIT_VOU_GUID + '", "' + PAY_VOU_DATE + '", "' + PAY_VOU_NO + '", "' + PAY_VOU_GUID + '", "' + EXPORT_DATE + '", "' + NOTE_TYPE + '", "' + FAIL_VOU_DATE + '", "' + FAIL_VOU_NO + '", "' + FAIL_VOU_GUID + '", "' + IMPORT_DATE +'");'
...
if __name__ == '__main__':
    ...
    # 现金结算
    make_sql('01', '上海市黄浦区', '01', 10)
    # 银行卡支付
    # make_sql('01', '上海市黄浦区', '02', 300)
