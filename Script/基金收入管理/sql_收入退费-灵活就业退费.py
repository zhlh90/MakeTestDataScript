...
def make_sql(agency_code, insurance_code, n):
    ...
    if not isExists:
        # 如果不存在则创建目录
        os.mkdir(path)
    file_name = path + 'SMR_REFUND_PERSON'+str(otherStyleTime3)+'.sql'
